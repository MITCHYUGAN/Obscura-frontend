...
export function DepositForm() {
  ...
  return (
    <div className="rounded-2xl border border-border/50 bg-card p-6 space-y-4">
      <div>
        <h3 className="font-semibold text-base">Deposit</h3>
      ...
      {/* Info banner */}
      <div className="flex gap-2 p-3 rounded-lg bg-emerald-950/30 border border-emerald-800/30 text-xs text-emerald-400/80">
        <Info className="w-3.5 h-3.5 flex-shrink-0 mt-0.5" />
        <span>
          Depositing is <strong className="text-emerald-300">public</strong> — the amount is
          visible on-chain. Once inside the pool, transfers are completely private.
        </span>
      </div>
